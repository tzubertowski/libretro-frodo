...
static SGOBJ miscdlg[] =
{
	...
	{ SGCHECKBOX, 0, 0, 10,3, 12,1, (char*)"Limit speeds" },
	{ SGCHECKBOX, 0, 0, 10,5, 11,1, (char*)"Fast Reset" },
	{ SGCHECKBOX, 0, 0, 10,7, 13,1, (char*)"CIA IRQ Hack" },
	{ SGCHECKBOX, 0, 0, 10,9, 13,1, (char*)"Map /" },


	{ SGTEXT, 0, 0, 1,7+4, 38,1, (char*)"Nrm Cycle" }, //6
	{ SGBUTTON,   SG_EXIT, 0, 15,7+4,  1,1, (char*)"+" },
	{ SGTEXT,     0, 0, 17,7+4,  3,1,mcycle[0] },
	{ SGBUTTON,   SG_EXIT, 0, 23,7+4,  1,1,  (char*)"-" },

	{ SGTEXT, 0, 0, 1,9+4, 38,1, (char*)"Bad Line" }, //10
	{ SGBUTTON,   SG_EXIT, 0, 15,9+4,  1,1, (char*)"+" },
	{ SGTEXT,     0, 0, 17,9+4,  3,1,mcycle[1] },
	{ SGBUTTON,   SG_EXIT, 0, 23,9+4,  1,1,  (char*)"-" },

	{ SGTEXT, 0, 0, 1,11+4, 38,1, (char*)"CIA cycle" },//14
	{ SGBUTTON,   SG_EXIT, 0, 15,11+4,  1,1, (char*)"+" },
	{ SGTEXT,     0, 0, 17,11+4,  3,1,mcycle[2] },
	{ SGBUTTON,   SG_EXIT, 0, 23,11+4,  1,1,  (char*)"-" },

	{ SGTEXT, 0, 0, 1,13+4, 38,1, (char*)"Flp Cycle" },//18
	{ SGBUTTON,   SG_EXIT, 0, 15,13+4,  1,1, (char*)"+" },
	{ SGTEXT,     0, 0, 17,13+4,  3,1,mcycle[3] },
	{ SGBUTTON,   SG_EXIT, 0, 23,13+4,  1,1,  (char*)"-" },

	{ SGTEXT,     0,0,  1, 19, 14,1,   (char*)"REU Size:" }, //22
	{ SGRADIOBUT, 0,0,  2+0, 21, 5,1,  (char*)"None" },
	{ SGRADIOBUT, 0,0,  2+10, 21, 5,1, (char*)"128k" },
	{ SGRADIOBUT, 0,0,  2+20, 21, 5,1, (char*)"256k" },
	{ SGRADIOBUT, 0,0,  2+30, 21, 5,1, (char*)"512k" },

	{ SGTEXT, 0, 0, 1,22, 38,1, NULL },
	{ SGBUTTON, SG_EXIT, 0, 16,23, 8,1, (char*)"OK" }, //28
	{ -1, 0, 0, 0,0, 0,0, NULL }
};
