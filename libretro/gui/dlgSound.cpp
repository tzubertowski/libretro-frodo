...
static SGOBJ sounddlg[] =
{
	...
	{ SGTEXT,     0,0,  4, 2, 13,1, (char*)"SOUND" },

	{ SGTEXT,     0,0,  4, 4, 14,1, (char*)"SID Emulation:" }, //3
	{ SGRADIOBUT, 0,0,  2, 6, 10,1, (char*)"None" },
	{ SGRADIOBUT, 0,0,  2, 7, 10,1, (char*)"Digital" },

	{ SGCHECKBOX, 0,0,  2, 9, 10,1, (char*)"SID filters" },
	{ SGBOX,      0,0,  1,18, 38,7, NULL }, //
	{ SGBUTTON, SG_EXIT/*SG_DEFAULT*/, 0, 10,23, 24,1, (char*)"Back to main menu" },//8
	{ -1, 0, 0, 0,0, 0,0, NULL }
};
